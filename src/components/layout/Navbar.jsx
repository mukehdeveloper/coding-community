...
const Navbar = () => {
  ...
  const getDashboardLink = () => {
    if (user?.role === 'chapter_leader') {
      return '/chapter-leader-dashboard';
    }
    return '/dashboard';
  };
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-16">
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <Link to="/tutorials" className="text-gray-700 hover:text-primary-600 px-3 py-2 rounded-md text-sm font-medium transition-colors">
              Tutorials
            </Link>
            <Link to="/events" className="text-gray-700 hover:text-primary-600 px-3 py-2 rounded-md text-sm font-medium transition-colors">
              Events
            </Link>
